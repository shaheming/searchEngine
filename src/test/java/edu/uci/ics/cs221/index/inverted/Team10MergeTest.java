...
public class Team10MergeTest {
  ...
  public void test1() {
    ...
    InvertedIndexSegmentForTest expected =
        new InvertedIndexSegmentForTest(expectedlist, expecteddocuments);
  ...
  public void test2() {
    ...
    InvertedIndexSegmentForTest expected1 =
        new InvertedIndexSegmentForTest(expectedlist1, expecteddocuments1);
    InvertedIndexSegmentForTest expected2 =
        new InvertedIndexSegmentForTest(expectedlist2, expecteddocuments2);
    invertedmanager.mergeAllSegments();
  ...
  public void clean() throws Exception {
    Path rootPath = Paths.get(this.path);
