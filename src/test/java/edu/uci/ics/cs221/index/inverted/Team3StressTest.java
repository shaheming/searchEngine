...
public class Team3StressTest {
  ...
  private static final String textUrl =
      "https://grape.ics.uci.edu/wiki/public/raw-attachment/wiki/cs221-2019-spring-project2/Team3StressTest.txt";
  ...
  public void setupAndRun() {
    ...
    assertTrue(
        PageFileChannel.writeCounter >= TOTALNUM / invertedIndexManager.DEFAULT_FLUSH_THRESHOLD);
