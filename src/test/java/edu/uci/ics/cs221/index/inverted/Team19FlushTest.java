...
public class Team19FlushTest {
  ...
  // test flush when flush() is called automatically when number of documents equals
  ...
  public void testFlush2() throws Exception {
    Document d1 =
        new Document(
            "Information retrieval is the activity of obtaining information system resources relevant to an information need from a collection");
    Document d2 =
        new Document("Searches can be based on full-text or other content-based indexing");
    Document d3 =
        new Document("The process may then be iterated if the user wishes to refine the query");
