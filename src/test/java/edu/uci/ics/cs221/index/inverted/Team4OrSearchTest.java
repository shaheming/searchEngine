...
public class Team4OrSearchTest {
  ...
  /**
   * Test 1: Test for normal search or case This test case is going to search "cat" or "apple" The
   * result should be doc1, doc2, doc3
   */
  @Test
  public void test1() {
  ...
  /** Test 2: Test for empty keyword Result should be an empty list of Documents */
  @Test
  public void test2() {
    // Generate keywords
  ...
  /** Test 3: Test for punctuation characters Results should be an empty list of Documents */
  @Test
  public void test3() {
    // Generate keywords
    List<String> keywords = Arrays.asList(",", ":./");
