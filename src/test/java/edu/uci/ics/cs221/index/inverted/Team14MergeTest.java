...
public class Team14MergeTest {
  ...
  Document[] documents1 =
      new Document[] {
        ...
        new Document(
            "At the end we had a chance to meet at the movie, but weren't thinking the same thing."),
  ...
  Document[] documents2 =
      new Document[] {
        ...
        new Document(
            "My favorite activity is watching a movie and eating pineapples at the same time"),
        ...
        new Document(
            "I'm going to have to find a way to get my diced pineapples into the movie theater")
      };
