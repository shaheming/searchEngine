 ...
 */
public class WordBreakTokenizerChen implements Tokenizer {
    ...
    public WordBreakTokenizerChen() {
        try {
            // load the dictionary corpus
            URL dictResource = WordBreakTokenizerChen.class.getClassLoader().getResource("cs221_frequency_dictionary_en.txt");
