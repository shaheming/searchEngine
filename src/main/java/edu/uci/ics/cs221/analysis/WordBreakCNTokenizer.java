...
// * - Stop words should be removed.
// * - If there's no possible way to break the string, throw an exception.
public class WordBreakCNTokenizer implements Tokenizer {
    ...
    public WordBreakCNTokenizer() {
        try {
            // load the dictionary corpus
            URL dictResource = WordBreakCNTokenizer.class.getClassLoader().getResource("dict_cn.txt");
